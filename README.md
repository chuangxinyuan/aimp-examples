...
* AIMP相关的文档位于 `./docs/samples/v1beta1/aimp/` 目录下
## AIMP公开模型列表

|名称|描述| 服务地址  |预测器| 模型格式| 模型文件下载地址| 版本| 文档 |
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
|-|-|-| [Triton Inference Server](https://github.com/triton-inference-server/server) | [TensorFlow,TorchScript,ONNX,TensorRT](https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/model_repository.html)| v2 |[Compatibility Matrix](https://docs.nvidia.com/deeplearning/frameworks/support-matrix/index.html)| [Triton Examples](./docs/samples/v1beta1/triton) |
|-|-|-| [TFServing](https://www.tensorflow.org/tfx/guide/serving) | [TensorFlow SavedModel](https://www.tensorflow.org/guide/saved_model) | v1 | [TFServing Versions](https://github.com/tensorflow/serving/releases) | [TensorFlow Examples](./docs/samples/v1alpha2/tensorflow)  |
|-|-|-| [TorchServe](https://pytorch.org/serve/server.html) | [Eager Model/TorchScript](https://pytorch.org/docs/master/generated/torch.save.html) | v1 | 0.3.0 | [TorchServe Examples](./docs/samples/v1beta1/torchserve)  |
|-|-|-| [SKLearn KFServer](https://github.com/kubeflow/kfserving/tree/master/python/sklearnserver) | [Pickled Model](https://scikit-learn.org/stable/modules/model_persistence.html) 文件后缀为joblib| v1 | 0.20.3 | [SKLearn Iris](./docs/samples/v1beta1/sklearn/v1)  |
...
### REST API调用序列如下
* [API详细参考和示例： /apis/v1beta/service/{name} - AIMPInferExample (apifox.cn)](https://www.apifox.cn/apidoc/project-1485755/api-35503298)， inferExample目录中的3个API。或者参考文档 [AIMP_INFER_REST_APIs.html](./docs/samples/v1beta1/aimp/useInferserviceMethods/AIMP_INFER_REST_APIs.html)
...
1. 获取推理服务的原始URL：REST服务端点：http://onepanel.niuhongxing.cn/api 。GET /apis/v1beta1/{namespace}/inferenceservice/{name}，header主要两个参数，namespace和 模型的名字name,返回原始的推理服务URL
1. 进行相应的推理服务调用：REST服务端点：https://infer.dev.aimpcloud.cn ， POST /v1/models/iris:predict，header 中主要2个参数，onepanel_access_token（上述API调用返回的 access_token)和 HOST（原始的推理服务URL中截取的主机地址）
...
* 参考代码 [efficientnet-v2-tfserving-test.py](./docs/samples/v1beta1/aimp/useInferserviceMethods/kf-serving-test/efficientnet-v2-tfserving-test.py)
### 在AIMP外部使用SDK
* 工作流内部使用时，需要指定AIMP的用户名和对应的token，还有AIMP的URL
* 参考代码[getAccessTokenExample.py](./docs/samples/v1beta1/aimp/useInferserviceMethods/getAccessTokenExample.py)
...
```
---
* 模型训练，打包，上线详细说明，请参考如下 original docs below
# KFServing 
